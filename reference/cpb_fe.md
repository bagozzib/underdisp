...
In the package's fixed-effects bias Monte Carlo (150 units, alpha = 0.5)
the alpha bias at T = 6/10/20/40 falls from -0.153/-0.100/-0.057/-0.033
to -0.046/-0.024/-0.013/-0.009. With correction on, `coefficients` and
